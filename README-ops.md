...
- 本地持久化：H2 文件库，默认落在 `./data/qqauto.mv.db`
...
- 若生产库改为 MySQL，可参考 [application-prod-mysql.properties.example](/D:/myproject/qqAuto/deploy/application-prod-mysql.properties.example)
